...
class OrderController extends AdminController
{
    ...
    protected function grid()
    {
        ...
        return Grid::make($model, function (Grid $grid) {
            ...
            $grid->column('pay_type',"mode of payment")->display(function($v){
                $display_v = null;
                switch ($v) {
                    case 1:
                        $display_v = "CSPAY";
            ...
            $grid->column('pay_status','pay status')->display(function($v){
                $display_v = null;
                switch ($v) {
                    case 1:
                        $display_v = "have paid";
            ...
            $grid->column('created_at', "created time");
            ...
            $grid->filter(function (Grid\Filter $filter) {
                ...
                $filter->equal("order_no","order no");
                $filter->equal("pay_status", "pay status")->select([
                    "2" => "non-payment",
                    "1" => "have paid"
                ]);
